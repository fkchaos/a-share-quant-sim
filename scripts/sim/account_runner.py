...
def _run_signal_impl(account_id, date, strategy_name=None):
    ...
    logger.info(f"DEBUG per_stock: available={available:,.0f}, n={n}, total_value={total_value:,.0f}, max_pos={max_pos}, per_stock={per_stock:,.0f}, available/n={available/n:,.0f}, total_value*max_pos={total_value*max_pos:,.0f}")
