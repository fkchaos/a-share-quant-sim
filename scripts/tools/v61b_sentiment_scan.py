#!/usr/bin/env python3
"""v61b + 情绪择时参数扫描（支持断点继续 + log输出）"""
import sys, os, json, time
sys.path.insert(0, '/root/a-share-quant-sim')
import sqlite3, numpy as np, pandas as pd

RESULT_FILE = '/root/a-share-quant-sim/scripts/tools/v61b_sentiment_results.json'
LOG_FILE = '/root/a-share-quant-sim/scripts/tools/v61b_sentiment_scan.log'
