...
### f0003a 等权组合因子（f0001a+f0002a）— 2026-08-18

**因子定义：**
```python
f0003a = 0.5 * rank(f0001a) + 0.5 * rank(f0002a)
```
...
- IR: 0.3653 ✅ (>0.3)
- P(>0): 62.7% ✅
- 分年：2022年IC=0.067最强，2026年IC=0.007最弱

**冗余度检查：**
- f0003a vs f0002a(IVOL): **0.817** ❌ 高度冗余
- f0003a vs Turnover20: -0.173 ✅ 独立

**结论：** IC有效但与f0002a高度冗余（0.82），组合无增量价值。IVOL主导了组合信号。**不进入WF**，直接用f0002a即可。
...
- [x] f0003a 组合因子：评估是否值得在zz1000池用 → **IC=0.051有效，但与f0002a高度冗余(0.82)**
