...
_ORD_TERMINAL_REJECT = {_ORD_ST_57_REJECTED}
_ORD_TERMINAL_CANCEL = {_ORD_ST_54_CANCELLED, _ORD_ST_53_PARTIAL_CANCELLED}  # 54=full cancel, 53=partial cancel (order done)
_ORD_CANCEL_PENDING = {_ORD_ST_51_CANCEL_REQ, _ORD_ST_52_PARTIAL_CANCEL_REQ}
